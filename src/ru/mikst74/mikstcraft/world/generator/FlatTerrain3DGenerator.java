...
public class FlatTerrain3DGenerator implements WorldMapGenerator {
    @Override
    public VoxelField createVoxelField(ChunkCoo chunkCoo) {
        ...
        res.store(new VoxelCoo(0, 0, 0), BlockTypeDictionary.getByNum(3));
        res.store(new VoxelCoo(0, 1, 0), BlockTypeDictionary.getByNum(3));
