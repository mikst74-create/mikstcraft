...
//                        uploadBlockType(new BlockTypeInfo(id.getAndIncrement(), "bb" + id.get(), FULL_SOLID_BLOCK, m)));
        uploadBlockType(new BlockTypeInfo(2, "bb" + id.get(), FULL_SOLID_BLOCK, new FaceMaterial(TextureDictionary.getTextureInfo("Grass"))));
        uploadBlockType(new BlockTypeInfo(3, "bb" + id.get(), FULL_SOLID_BLOCK, new FaceMaterial(TextureDictionary.getTextureInfo("Bedrock"))));
        uploadBlockType(new BlockTypeInfo(4, "bb" + id.get(), FULL_SOLID_BLOCK, new FaceMaterial(TextureDictionary.getTextureInfo("Bricks"))));
        uploadBlockType(new BlockTypeInfo(5, "bb" + id.get(), FULL_SOLID_BLOCK, new FaceMaterial(TextureDictionary.getTextureInfo("Basalt"))));
        uploadBlockType(new BlockTypeInfo(6, "bb" + id.get(), FULL_SOLID_BLOCK, new FaceMaterial(TextureDictionary.getTextureInfo("Acacia"))));
